...
namespace rendering_program
{
	...
	void initialize()
	{
		GLuint vertex_shader = load_shader("Resources/plugins/Enhanced_Cloudscapes_Engine/shaders/rendering/vertex_shader.glsl", GL_VERTEX_SHADER);
		GLuint fragment_shader = load_shader("Resources/plugins/Enhanced_Cloudscapes_Engine/shaders/rendering/fragment_shader.glsl", GL_FRAGMENT_SHADER);
