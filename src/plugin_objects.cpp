...
namespace plugin_objects
{
	...
	void initialize()
	{
		...
		cloud_map_textures[0] = load_png_texture("Resources/plugins/Enhanced_Cloudscapes_Engine/textures/cloud_map_1.png", false);
		cloud_map_textures[1] = load_png_texture("Resources/plugins/Enhanced_Cloudscapes_Engine/textures/cloud_map_2.png", false);
		cloud_map_textures[2] = load_png_texture("Resources/plugins/Enhanced_Cloudscapes_Engine/textures/cloud_map_3.png", false);

		base_noise_texture = load_png_texture("Resources/plugins/Enhanced_Cloudscapes_Engine/textures/base_noise.png", true);
		detail_noise_texture = load_png_texture("Resources/plugins/Enhanced_Cloudscapes_Engine/textures/detail_noise.png", true);

		blue_noise_texture = load_png_texture("Resources/plugins/Enhanced_Cloudscapes_Engine/textures/blue_noise.png", false);
