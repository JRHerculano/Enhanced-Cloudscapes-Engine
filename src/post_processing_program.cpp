...
namespace post_processing_program
{
	...
	void initialize()
	{
		GLuint vertex_shader = load_shader("Resources/plugins/Enhanced_Cloudscapes_Engine/shaders/post_processing/vertex_shader.glsl", GL_VERTEX_SHADER);
		GLuint fragment_shader = load_shader("Resources/plugins/Enhanced_Cloudscapes_Engine/shaders/post_processing/fragment_shader.glsl", GL_FRAGMENT_SHADER);
